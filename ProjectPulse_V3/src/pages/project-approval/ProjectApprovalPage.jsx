                  ...
                  <td style={{ padding: "11px 16px", textAlign: "center" }}>
                    {r.status === "Pending" ? (
                      <div style={{ display: "inline-flex", gap: 8 }}>
                        ...
                        <button onClick={() => openDecision(r, "Rejected")} style={{ display: "inline-flex", alignItems: "center", gap: 6, background: COLORS.dangerSoft, color: COLORS.danger, border: "none", borderRadius: 7, padding: "6px 11px", fontSize: 12.5, fontWeight: 600, cursor: "pointer" }}>
                          <X size={12} /> Reject
                        </button>
                      </div>
