...
export function DepartmentPanel({ mode, data, saving, error, codeLocked, onCancel, onClose, onSubmit }) {
      ...
      <div style={{ padding: 20, flex: 1, overflowY: "auto" }}>
        ...
        {codeLocked && (
          <div style={{ fontSize: 11.5, color: COLORS.textMuted, marginTop: 4 }}>
            Code is locked — this department is already in use elsewhere (Users, Projects, or Resources).
          </div>
        )}
